...
export function Scene8DarkCurrent({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-xl h-64 mx-auto flex items-stretch border border-white/5 rounded-2xl overflow-hidden shadow-2xl mb-12">
      ...
      <div className="text-center w-full max-w-2xl mx-auto">
        <h2 className="text-xl md:text-2xl text-white font-light tracking-wide mb-3">Dark Current</h2>
