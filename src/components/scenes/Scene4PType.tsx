  ...
  return (
    ...
    >
      <div className="absolute top-1/4 text-center w-full">
        <h2 className="text-xl md:text-2xl text-[#CA4A4A] font-light tracking-wide mb-2">P-Type Doping</h2>
      ...
      <div className="mt-20 relative w-64 h-64 md:w-80 md:h-80 mx-auto bg-[#2A1010]/30 border border-[#5A2020] rounded-2xl flex flex-wrap content-center justify-center gap-6 p-8">
